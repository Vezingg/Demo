...
# --- Other Admin Functions (if needed, otherwise they can be pruned) ---
...
with gr.Blocks(css=custom_css, title="Lil Lisa Server") as demo:
    ...
    with gr.Tab("Chatbot"):
        ...
        # Row for "Send Query" and "Clear Chat"
        with gr.Row():
        ...
        # Thumbs Up/Down row placed BELOW the Chatbot output (acting as a reaction to the latest answer)
        with gr.Row():
